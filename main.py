...
with header:
    ...
    st.write('This is an application I quickly developed to test and deploy a Deep Learning model I created which classifies images between my two different foods! Pizza and Steak')
with body:
